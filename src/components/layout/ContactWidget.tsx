...
const INITIAL_MESSAGES: ChatMessage[] = [
  {
    id: "welcome",
    role: "system",
    text: "Hi! Have a request or question about Hibiki? Send a message below — I reply by email, usually within 2-3 days😉",
  },
];
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label={isOpen ? "Close inquiry chat" : "Open inquiry chat"}
          ...
          <form ref={form} onSubmit={sendEmail} className="border-t border-slate-800 px-4 py-3">
            ...
            <div className="flex items-end gap-2">
              <textarea
                ...
                name="message"
                rows={2}
                placeholder="Write message to Hibiki..."
                required
                onKeyDown={(e) => {
