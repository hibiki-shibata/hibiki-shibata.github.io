    ...
    return (
        <>
            ...
            <div id="job-experience-card">
                ...
                {/* <a class="job-experience-card__wolt" */}
                <a
                    href="https://explore.wolt.com/en/jpn/about?_gl=1*68oxvh*_gcl_au*MTQ3MTUzODQyNS4xNzUwOTk2NTkw*_ga*MTM1Mjk0NjQ1Mi4xNzUwNjM3MzYx*_ga_CP7Z2F7NFM*czE3NTU4NTQ4NDckbzQ2JGcxJHQxNzU1ODU0OTM2JGozNCRsMCRoMA.."
                    target="_blank">
                    <h3>
                        Wolt / DoorDash ( Tokyo, Japan )
                        {/* <h data-i18n="woltTechJobTitle">- Tech Support Engineer</h> */}
                        <h4>- Tech Support Engineer</h4>
                    </h3>
                    <p data-i18n="woltTechYears">March 2022 - Present ( 3 years ) </p>
                </a>
                <blockquote>
                    <ul>
                        <li>
                            <b data-i18n="woltTechExperienceSoftwareDev">Internal Tool Development: </b>
                            <dt data-i18n="woltTechExperienceSoftwareDevDescr">
                        ...
                        <li>
                            <b data-i18n="woltTechExperienceDebug">System Debugging & Incident Analysis: </b>
                            <dt data-i18n="woltTechExperienceDebugDescr">
                        ...
                        <li>
                            <b data-i18n="woltTechExperienceAnalytics">Data Analytics & Reporting: </b>
                            <dt data-i18n="woltTechExperienceAnalyticsDescr">
                                Responded to business team requests by extracting and analyzing data using SQL queries to
                                support strategic decision-making.
                            </dt>
                        </li>
                        <li>
                            <b data-i18n="woltTechExperienceTechSupport">Technical Support: </b>
                            <dt data-i18n="woltTechExperienceTechSupportDescr">
                        ...
                        <li>
                            <b data-i18n="woltTechExperienceAccessManage">Access & Device Management: </b>
                            <dt data-i18n="woltTechExperienceAccessManageDesc">
                        ...
                        <li>
                            <b data-i18n="woltTechExperiencePoliceReq"> Legal & Compliance Support: </b>
                            <dt data-i18n="woltTechExperiencePoliceReqDesc">
                ...
                {/* <h3 class="job-experience-card__show-description-button-title">- Description -</h3> */}
                <h3 >- Description -</h3>
                <button >Show
                    {/* <button class="job-experience-card__show-description-button" onclick="toggleDescription(this)">Show */}
                    Description</button>

                {/* <blockquote class="job-experience-card__description-content" data-i18n="woltTechExperienceDescriptionContent"> */}
                <blockquote data-i18n="woltTechExperienceDescriptionContent">
                ...
                <a
                    ...
                    target="_blank">
                    <h3>
                        Wolt / DoorDash ( Fukuoka, Japan )
                        {/* <h data-i18n="woltSAJobTitle">- Support Associate</h> */}
                        <h4>- Support Associate</h4>

                    </h3>
                    <p data-i18n="woltSAYears">September 2021 - March 2022 ( 8 months ) </p>
                </a>

                <blockquote>
                    <ul>
                        <li>
                            <b data-i18n="woltSAExperienceUserSupport">Users support: </b>
                        </li>
                        <li>
                            <b data-i18n="woltSAExperienceCourierSupport">Courier partners support: </b>
                        </li>
                        <li>
                            <b data-i18n="woltSAExperienceRestaurantSupport">Restaurants partners support: </b>
                        </li>
                    </ul>
                    <p data-i18n="woltSAExperienceDescr">( Online chat support, Phone support, Japanese/English )</p>
                </blockquote>
                ...
                <blockquote data-i18n="woltSAExperienceDescriptionContent">
                    {/* <blockquote class="job-experience-card__description-content" data-i18n="woltSAExperienceDescriptionContent"> */}
